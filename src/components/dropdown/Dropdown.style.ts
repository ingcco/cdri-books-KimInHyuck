...
export const dropdownVariants = tv({
  slots: {
    trigger:
      "flex w-full items-center justify-between gap-1 border-b border-[#D2D6DA] py-2 body2-bold text-text-primary outline-none focus-visible:border-primary",
    ...
    chevron: "size-3 shrink-0 transition-transform duration-150",
  },
});
